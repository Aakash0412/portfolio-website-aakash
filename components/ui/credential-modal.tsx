...
export function CredentialModal({ children, tag, title, org, description }: CredentialModalProps) {
  return (
    <Dialog>
      ...
      <DialogContent className="border-0 shadow-2xl p-0 rounded-3xl overflow-hidden bg-transparent" style={{ maxWidth: "550px" }}>
        ...
        <div className="relative bg-[#0a0a0a]/95 backdrop-blur-3xl p-8 border border-white/5 rounded-3xl z-10">
          <DialogHeader>
